...
public class Climber extends Subsystem
{
    ...
    private boolean _isExtended = false;// True if the DoubleSolenoid is extended, false otherwise

    // Constructor
    public Climber()
    {
        this._solenoid1 = new DoubleSolenoid(/*RobotMap.Motors.Climber.PCM_ID, */RobotMap.Motors.Climber.FORWARD_SOLENOID1,
                                            RobotMap.Motors.Climber.REVERSE_SOLENOID1);
        this._solenoid2 = new DoubleSolenoid(/*RobotMap.Motors.Climber.PCM_ID, */RobotMap.Motors.Climber.FORWARD_SOLENOID2,
    ...
    public void toggleSolenoid()
    {
        ...
        else
        {
            ...
            this._solenoid2.set(DoubleSolenoid.Value.kReverse);
        }
        SmartDashboard.putBoolean("Pneu Extended", _isExtended);
    }
    ...
    public void stopSolenoid()
    {
        ...
        this._solenoid2.set(DoubleSolenoid.Value.kOff);
    }
